    ...
    return <div className="flex flex-col gap-6">
        <div className="grid w-full mx-auto grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <Card className="flex flex-col sm::grid grid-cols-4 gap-6">
                <h2 className="w-full text-dark-tremor-content-string text-center
                sm:left-left font-semibold text-xl">This weeks top visitors</h2>
                <div className="col-span-3 flex items-center justify-between flex-wrap gap-8">
                    {topCountries?.map(([countryCode, number]) => {
                        return <div className="flex items-center gap-3 text-dark-tremor-content-strong">
                            <p className='hiden sm:block text-tremor-content'>
                                {countryCode}
                            </p>
                            <ReactCountryFlag
